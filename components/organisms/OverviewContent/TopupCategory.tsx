...
interface TopupCategoryProps {
  children: ReactNode;
  nominal: number;
  icon: "ic-category-desktop" | "ic-category-mobile" | "ic-category-others";
}

export default function TopupCategory(props: TopupCategoryProps) {
